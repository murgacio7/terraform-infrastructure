...
module "ecom-terraform-helm" {
  ...
  deployment_name      = "ecom-app"
  deployment_namespace = module.ecom-terraform-k8s-namespace.namespace
  deployment_path      = "./charts/ecom-app"
  values_yaml          = <<EOF

image:
  repository: us-central1-docker.pkg.dev/terraform-project-main-project/docker-registry/simple-website
